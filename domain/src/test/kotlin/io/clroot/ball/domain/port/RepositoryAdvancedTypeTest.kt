...
data class StringId(val value: String)
data class LongId(val value: Long)
...
class GenericRepositoryTest {
    ...
    fun testVariousScenarios() {
        // SimpleEntity 테스트
        val simpleRepo = object : SimpleEntityRepository {
            ...
            override fun update(id: BinaryId, modifier: (SimpleEntity) -> Unit): SimpleEntity {
        ...
        val orderRepo = object : OrderRepository {
            ...
            override fun delete(id: BinaryId) {}
            override fun update(id: BinaryId, modifier: (Order) -> Unit): Order {
                throw NotImplementedError()
            }
        }
...
class CovarianceTest {
    ...
    fun testCovariance() {
        val orderRepo: OrderRepository = object : OrderRepository {
            override fun findById(id: BinaryId): Order? = null
            override fun findAll(): List<Order> = emptyList()
            override fun save(entity: Order): Order = entity
            override fun delete(id: BinaryId) {}
